// ============================================================
// DOCTOR PROFILE SCREEN - User Profile and Settings
// ============================================================
// This screen displays the doctor's profile information,
...
/// Doctor Profile Screen - Displays user info and settings
///
/// Uses Riverpod to access the current authenticated user and lecturer data.
/// Shows profile header with avatar, name, and email.
/// Contains settings section and logout button.
class DoctorProfileScreen extends ConsumerWidget {
  /// Creates the doctor profile screen
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Get lecturer data from lecturer provider
    final lecturer = ref.watch(lecturerProvider).lecturer;
              ...
              child: Column(
                children: [
                  ...
                  CircleAvatar(
                    ...
                    child: Text(
                      // Display first letter of user name, fallback to 'D'
                      lecturer?.name.substring(0, 1).toUpperCase() ?? 'D',
                  ...
                  // Display lecturer name or fallback text
                  Text(
                    lecturer?.name ?? user?.name ?? 'Doctor Name',
                    style: const TextStyle(
                      fontSize: 20,
                      fontWeight: FontWeight.bold,
                    ),
                  ...
                  // Display lecturer email or fallback text
                  Text(
                    lecturer?.email ?? user?.email ?? 'doctor@university.edu',
